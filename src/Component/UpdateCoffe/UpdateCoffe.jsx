...
const UpdateCoffe = () => {
  ...
  return (
    <div className="bg-gray-300 p-32" >
      <h1 className="text-3xl mb-3 font-extrabold ml-4 ">Update Coffee : {name}</h1>
      <p className="mb-3 ml-4">It is a long established fact that a reader will be distraceted by the readable <br /> content of a page when looking at its layout. The point of using Lorem Ipsum is that it <br />
        has a more-or-less normal distribution of letters, as opposed to using Content here.</p>

      {/* from */}
      <form onSubmit={handelUpdate}  className=" text-center">
        ...
        <div className="md:flex mb-8">
          ...
          <div className="form-control md:w-1/2 ml-4">
            ...
            <label className="input-group">
              <span>Taste</span>
              <input type="text" name="taste" defaultValue={taste} placeholder="Coffee Test" className="input input-bordered w-full" />
            </label>
          </div>
        </div>
        ...
        <div className="form-control w-full ml-4 mb-8">
          ...
          <label className="input-group">
            <span>Photo</span>
            <input type="text" name="photo" defaultValue={photo} placeholder="info@site.com" className="input input-bordered w-full" />
          </label>
        </div>
        <input type="submit" value="Update Coffee" className="btn btn-block ml-4" />
      </form>
    </div>
  );
};
